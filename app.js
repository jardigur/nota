...
function syncStateToForm() {
  ...
  document.getElementById('order-no').value = state.order.no;
  document.getElementById('order-datetime').value = state.order.datetime;
  document.getElementById('order-deadline').value = state.order.deadline;
  document.getElementById('cost-finishing').value = state.payment.finishing;
  document.getElementById('cost-discount').value = state.payment.discount;
  document.getElementById('amount-paid').value = state.payment.paid;
  document.getElementById('payment-status').value = state.payment.status;
}
...
function saveToStorage() {
  try {
    localStorage.setItem('mangrove_pos_state', JSON.stringify(state));
  } catch (e) {
...
function loadFromStorage() {
  try {
    const saved = localStorage.getItem('mangrove_pos_state');
    if (saved) {
